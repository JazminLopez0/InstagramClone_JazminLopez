  ...
  PreferredSizeWidget _appBar() {
    return AppBar(
      ...
      actions: <Widget>[
        IconButton(
          onPressed: () {},
          icon: Icon(Feather.tv, color: Colors.black, size: 28),
        ),
        IconButton(
          onPressed: () {},
          icon: Icon(FontAwesome.send_o, color: Colors.black, size: 28),
        ),
      ],
    );
  }
  ...
  Widget _crearHistoria(Storie storie) {
    return Column(
      children: <Widget>[
        ...
        SizedBox(height: 6),
        Text(storie.name, style: TextStyle(fontSize: 13))
      ],
    );
  }
                ...
                Row(
                  children: <Widget>[
                    IconButton(
                      onPressed: () {},
                      icon: Image(
                          image: AssetImage('assets/img/heart.png'), width: 30),
                    ),
                    IconButton(
                      onPressed: () {},
                      icon: Image(
                    ...
                    IconButton(
                      onPressed: () {},
                      icon: Image(
                          image: AssetImage('assets/img/send.png'), width: 30),
                    ),
                  ],
                ),
                IconButton(
                  onPressed: () {},
                  icon: Image(
                      image: AssetImage('assets/img/save_o.png'), width: 30),
                ),
              ],
            ),
          ),
